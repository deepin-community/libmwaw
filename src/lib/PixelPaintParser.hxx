...
#ifndef PIXELPAINT_PARSER
#  define PIXELPAINT_PARSER
...
/** \brief the main class to read a PixelPaint file or a PNTG file
 *
 */
class PixelPaintParser final : public MWAWGraphicParser
{
public:
  //! constructor
