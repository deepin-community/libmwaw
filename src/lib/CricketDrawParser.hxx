...
#ifndef CRICKETDRAW_PARSER
#  define CRICKETDRAW_PARSER
...
/** \brief the main class to read a CricketDraw v0,v1 file
 *
 */
class CricketDrawParser final : public MWAWGraphicParser
{
  friend class CricketDrawParserInternal::SubDocument;
public:
  //! constructor
