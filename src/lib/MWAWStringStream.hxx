 ...
 */
class MWAWStringStream final : public librevenge::RVNGInputStream
{
public:
  //! constructor
...
private:
  ...
  MWAWStringStream(const MWAWStringStream &) = delete; // copy is not allowed
  MWAWStringStream &operator=(const MWAWStringStream &) = delete; // assignment is not allowed
};
