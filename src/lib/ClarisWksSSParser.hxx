...
/*
 * Parser to Claris Works spreadsheet document
 *
 */
#ifndef CLARIS_WKS_SS_PARSER
#  define CLARIS_WKS_SS_PARSER
 ...
 *
 */
class ClarisWksSSParser final : public MWAWSpreadsheetParser
{
  friend class ClarisWksSSParserInternal::SubDocument;
