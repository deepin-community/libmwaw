 ...
 */
class MacDocParser final : public MWAWTextParser
{
public:
  //! constructor
  MacDocParser(MWAWInputStreamPtr const &input, MWAWRSRCParserPtr const &rsrcParser, MWAWHeader *header);
  //! destructor
  ~MacDocParser() final;
...
protected:
  ...
  //
  //! the state
  std::shared_ptr<MacDocParserInternal::State> m_state;
};
#endif
